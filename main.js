...
function fetchUserDetails() {
    return axios.get('https://crudcrud.com/api/903d7643c0fb4febab9a225c7626be3a/appointmentData');
}

// Function to update user details in the cloud
function updateUserDetails(userDetailsArray) {
    return axios.put('https://crudcrud.com/api/903d7643c0fb4febab9a225c7626be3a/appointmentData', { data: userDetailsArray });
}
...
function submitForm() {
    ...
    axios.post('https://crudcrud.com/api/903d7643c0fb4febab9a225c7626be3a/appointmentData', userDetails)
        .then(function (response) {
            // Handle the success response if needed
